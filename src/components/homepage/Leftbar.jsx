...
const ExpandLeftMenu = ({ Icon, children }) => {
  ...
  return (
    <>
      ...
      {expandMenu && children ? <div className="transition-all duration-500 ease-in-out">{children}</div> : null}
...
export default function Leftbar({ authUser }) {
  ...
  const urlProfileImageUserLogin = profileImage ? `http://localhost:5000/img/profile_images/${profileImage}` : 'img/profile-default.jpg'
