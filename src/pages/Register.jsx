      ...
      {openModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50">
          <div className="bg-white w-[500px] rounded-lg pb-5">
            ...
            <div className="">
              {/* Form */}
              <form onSubmit={formik.handleSubmit} className="px-7 pt-7 ">
                <div className="flex flex-col gap-y-4">
                  <div className="flex items-center gap-x-3">
                    {/* First Name */}
                    <div
                      className={`${
                        formik.errors.first_name && "flex flex-col"
                      }`}
                    >
                      <input
                        type="text"
                        ...
                        className={`border ${
                          formik.errors.first_name && formik.touched.first_name
                            ? "border-red-500"
                            : "border-slate-300"
                        } rounded-lg placeholder:text-slate-300 w-full`}
                      />
                      {formik.errors.first_name &&
                        formik.touched.first_name && (
                          <p className="text-[14px] text-red-500 ml-1 mt-1">
                            {formik.errors.first_name}
                          </p>
                        )}
                    </div>
                    ...
                    {/* Surname */}
                    <div
                      className={`${formik.errors.surname && "flex flex-col"}`}
                    >
                      <input
                        type="text"
                        name="surname"
                  ...
                  <div
                    className={`w-full ${
                      formik.errors.email && "flex flex-col"
                    }`}
                  >
                    <input
                      type="email"
                      ...
                      className={`w-full border ${
                        formik.errors.email && formik.touched.email
                          ? "border-red-500 "
                          : "border-slate-300 "
                      } rounded-lg placeholder:text-slate-300`}
                    />
                    {formik.errors.email && formik.touched.email && (
                      <p className="text-[14px] text-red-500 ml-1 mt-1">
                        {formik.errors.email}
                  ...
                  <div
                    className={`w-full ${
                      formik.errors.password && "flex flex-col"
                    }`}
                  >
                    <input
                      type="password"
                ...
                <div className="mt-5">
                  ...
                  <div className="flex gap-5">
                    ...
                    >
                      {/* Default Option */}
                      <option value={null} disabled={formik.values.day !== ""}>
                        Select Day
                      </option>
                    ...
                    >
                      {/* Default Option */}
                      <option value={null} disabled={formik.values.year !== ""}>
                        Select Year
                      </option>
